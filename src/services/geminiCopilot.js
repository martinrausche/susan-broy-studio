// Minimalist Artwork Datasets & Gemini Copilot Service for Susan Broy
...
// High-end minimalist sculpture and abstract art image presets
export const PRESET_IMAGES = {
  concrete: 'https://images.unsplash.com/photo-1544717305-2782549b5136?auto=format&fit=crop&w=1200&q=85', // Concrete architectural sculpture
  metal: 'https://images.unsplash.com/photo-1579783902614-a3fb3927b675?auto=format&fit=crop&w=1200&q=85', // Metallic geometric installation
  bw_painting: 'https://images.unsplash.com/photo-1541701494587-cb58502866ab?auto=format&fit=crop&w=1200&q=85', // B&W abstract canvas painting
  mixed: 'https://images.unsplash.com/photo-1513519245088-0e12902e5a38?auto=format&fit=crop&w=1200&q=85' // Modern dark structural sculpture
};
...
export const DEMO_POSTS = [
  {
    ...
    date: '2026-07-28',
    type: 'reel',
    mediaUrl: PRESET_IMAGES.concrete,
    keywords: 'Raumwirkung, Gießbeton, Schattenwurf, Stille, Minimalismus',
    ...
    variants: [
      {
        ...
        style: 'Slow pan across raw concrete texture and architectural shadow',
        ...
        hashtags: ['#susanbroy', '#concreteart', '#contemporarysculpture', '#formimraum', '#minimalism'],
        audio: 'Ambient Calm — Deep Resonance',
        layout: 'fullscreen_clean'
      },
      {
        id: 'var-1-b',
        name: 'Variant B: Grafik & Kontrast (BROY Frame)',
        style: 'High contrast B&W frame with BROY logo watermark',
        caption: `Skulpturale Masse & Schatten.\n\nForm IV im architektonischen Raumkontext. Wenn das Material zur Skulptur wird und den Raum besetzt.\n\nGezeigt bei @galerie_vonundvon\nAtelier: @syken_broy`,
      ...
      },
      {
        ...
        style: 'Process storytelling focus with exhibition notes',
  ...
  },
  {
    ...
    date: '2026-07-30',
    type: 'feed',
    mediaUrl: PRESET_IMAGES.bw_painting,
    ...
    variants: [
      {
        ...
        style: 'Dynamic pop highlighting the vibrant neon line on B&W canvas',
        ...
        hashtags: ['#susanbroy', '#blackandwhiteart', '#accentcolor', '#contemporarypainting'],
        audio: 'Modern Minimal — Crisp Tone',
        layout: 'fullscreen_clean'
      },
      {
        id: 'var-2-b',
        name: 'Variant B: Editorial Gallery Frame',
        style: 'Museum gallery border with crisp BROY watermark',
        ...
        hashtags: ['#susanbroy', '#galleryart', '#minimalistpainting', '#artcollector'],
        audio: 'Atmospheric Soft Tone',
        layout: 'passepartout_light'
      },
      {
        id: 'var-2-c',
        name: 'Variant C: Dual Texture Detail',
...
export async function generatePostVariants(inputData) {
  ...
  const defaultImage = PRESET_IMAGES[inputData.medium] || PRESET_IMAGES.concrete;
  ...
  return {
    ...
    mediaUrl: inputData.mediaUrl || defaultImage,
